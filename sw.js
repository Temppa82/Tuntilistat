const BASE=new URL('./',self.location.href),PREFIX='ajolista-local-'+BASE.pathname+'-',CACHE=PREFIX+"2.11.0-68bb61e72b543b69",URLS=["icon-192.png","icon-512.png","index.css","index.html","index.js","manifest.webmanifest"].map(p=>new URL(p,BASE).href),LIVE=["index.css","index.js"].map(p=>new URL(p,BASE).href);
