const BASE=new URL('./',self.location.href),PREFIX='ajolista-local-'+BASE.pathname+'-',CACHE=PREFIX+"cc211437dc82bf28",URLS=["icon-192.png","icon-512.png","index-BBVtZk1X.css","index-CHQL-PuD.js","index.html","manifest.webmanifest"].map(p=>new URL(p,BASE).href);
