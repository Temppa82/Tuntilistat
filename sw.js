const BASE=new URL('./',self.location.href),PREFIX='ajolista-local-'+BASE.pathname+'-',CACHE=PREFIX+"773c35fbaebb2097",URLS=["icon-192.png","icon-512.png","index-BBVtZk1X.css","index-DzSR3-Uy.js","index.html","manifest.webmanifest"].map(p=>new URL(p,BASE).href);
